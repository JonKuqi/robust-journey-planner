...
(a) The time performance of your solution will be evaluated along two dimensions:
  ...
  - Your performance will be evaluated relative to the class results for both components. Implementations that are significantly slower than the typical range (either in preprocessing time or routing time) may receive lower scores.
